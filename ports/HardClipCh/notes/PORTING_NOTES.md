...
## Scope Chosen
Port target: the chowdsp_utils `ADAAHardClipper`, exposed as:

```supercollider
HardClipCh.ar(in, mul = 1, add = 0)
```

This scope includes:

1. the original hard-clipping transfer curve
